...
do arquivo mestre a leitura de todo o arquivo de transações.
...
def impr():
    ...
    while True:        
        ...
        nome=valor1[1]    
        if matr1=='*':  return     
        arq2.seek(0) # volta ao inicio de arq2
        print (' \nMatricula: {:4s}  Nome:  {:30s}  '.format(matr1,nome))
        # percorre todo arq2 e seleciona os de mesma matricula
        while True:
            mat2=arq2.readline()
            valor2=mat2.split(',')
            matr2=valor2[0]
...
# programa principal
import os
os.chdir('f:') # muda o diretorio corrente para f:
